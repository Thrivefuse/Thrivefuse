...
import {PARENT_REGISTRATION_PAGE, TUTOR_REGISTRATION_PAGE} from "../../utils/constants";
        ...
        <>
            ...
            <section className={style.first} id="first">
                <div className={style.text}>
                    ...
                    <div className={style.con}>
                        <button onClick={(event)=>navigateTo(event, PARENT_REGISTRATION_PAGE)} className={style.cta}>Become a parent</button>
                        <button onClick={(event)=>navigateTo(event, TUTOR_REGISTRATION_PAGE)} className={style.cta}>Become a Tutor</button>
                    </div>
                </div>
            ...
            <section className={style.thrivefuse} id="second">
                <div className={style.text2}>
                    ...
                    <div className={style.about}>
                        ...
                        <p className={style.textAbou}>
                            Welcome to ThriveFuse, where we are on a mission to empower individuals with the support
                            they need to navigate life's challenges and uncertainties. We believe that everyone deserves
                            the opportunity to contribute to and benefit from the growth of the economy.
                            Our unique approach goes beyond traditional education—we focus on providing practical skills and fostering
                            an environment of continuous learning to ensure individuals are well-equipped for the dynamic demands
                            of the modern world.
                        </p>
                    </div>
                    <div className={style.mission} id={"our mission"}>
                        ...
                        <p className={style.textAbou}>
                            ThriveFuse is committed to promoting social protection through a holistic approach
                            that combines essential skills development, financial support, and a culture of adaptability.
                            Our mission is to empower individuals, irrespective of their background or circumstances,
                            with the tools they need to thrive in an ever-changing economic landscape.
                            By offering a support system that goes beyond conventional education,
                            we aim to create a more resilient and inclusive society.
                        </p>
                    </div>
                    <div className={style.vision} id={"our vision"}>
                        <h6 className={style.aboutMess}>Our Vision</h6>
                        <p className={style.textAbou}>
                            To be a catalyst for societal transformation, where individuals are not only equipped with practical skills
                            but also supported in facing the uncertainties of life. ThriveFuse envisions a world
                            where everyone has the means to contribute meaningfully to economic growth and
                            where social protection is the cornerstone of a prosperous and inclusive global community.
                            Through our vision, we aspire to redefine the paradigm of support, ensuring that individuals not only survive
                ...
                <div className="image2">
                    <img src={Kids} alt="Kids learning with entusiasm" className={style.enthusiastImage} srcSet=""/>
                </div>
            </section>
            ...
            <section className={style.courses} id="course">
                ...
                <div className={style.systemContainer}>
                    <div className={style.SystemBox} style={{border: "1px solid var(--main-color)"}}>
                        <img src={Program} className={style.systemImage}
                    ...
                    <div className={style.SystemBox} style={{ border: "1px solid var(--main-color)" }}>
                        <img
                          src={Entrepreneur} className={style.systemImage} srcSet=""
